package com.ifudata.ic.pay.web.demo.controller;
...
import com.ifudata.ic.pay.web.demo.util.ConfigUtil;
import com.ifudata.ic.pay.web.demo.util.HTTPUtil;
import com.ifudata.ic.pay.web.demo.util.PaymentUtil;
import com.ifudata.ic.pay.web.demo.util.VerifyUtil;
...
public class DemoController {
    ...
    public String index(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String orderId = DateUtil.getDateString(new Date(), "yyyyMMddhhmmss");
