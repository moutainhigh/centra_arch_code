package com.ifudata.ic.smc.calculate.topology.core.bolt;
...
import com.ifudata.ic.smc.calculate.topology.core.proxy.CalculateProxy;
import com.ifudata.ic.smc.calculate.topology.core.util.LoadConfUtil;
...
//                    .getCacheClient(SmcCacheConstant.NameSpace.CAL_COMMON_CACHE);
            String counter = String.valueOf(RedisConfUtil.hincrBy(SmcCacheConstant.Cache.COUNTER,
                    bsn, 1));
            LOG.info("详单算费累加器[key1:" + SmcCacheConstant.Cache.COUNTER + ", key2:" + bsn
                    + ", value = " + counter + "]");
            String original = StringUtils.defaultString(RedisConfUtil.hget(
