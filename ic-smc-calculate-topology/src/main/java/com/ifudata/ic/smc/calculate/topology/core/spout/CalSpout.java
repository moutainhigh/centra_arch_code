package com.ifudata.ic.smc.calculate.topology.core.spout;
...
import com.ifudata.ic.smc.calculate.topology.core.bo.FinishListVo;
...
public class CalSpout extends BaseRichSpout {
    ...
    Map conf, TopologyContext context, SpoutOutputCollector collector) {
    	LoadConfUtil.loadRedisConf(conf);
...
//                .getCacheClient(SmcCacheConstant.NameSpace.STATS_TIMES);
        String finishlist = RedisConfUtil.hget(SmcCacheConstant.NameSpace.STATS_TIMES,
        ...
        RedisConfUtil.hdel(SmcCacheConstant.NameSpace.STATS_TIMES,
                SmcCacheConstant.Cache.finishKey);
        for (FinishListVo vo : voList) {
            ...
            RedisConfUtil.hset(SmcCacheConstant.Cache.lockKey, batchNo, vo.getStats_times());
            try {
