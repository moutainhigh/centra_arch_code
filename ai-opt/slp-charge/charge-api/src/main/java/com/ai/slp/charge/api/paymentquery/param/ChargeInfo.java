...
public class ChargeInfo implements Serializable {
    ...
    private static final long serialVersionUID = -8772209578385783908L;
     ...
     * 费用明细 列表
     */
    private List<ChargeDetailInfo> details;
    ...
    public List<ChargeDetailInfo> getDetails() {
        return Collections.unmodifiableList(details);
    }

    public void setDetails(List<ChargeDetailInfo> details) {
