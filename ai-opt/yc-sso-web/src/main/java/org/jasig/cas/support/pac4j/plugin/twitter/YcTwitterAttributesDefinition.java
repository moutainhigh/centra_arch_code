...
import org.pac4j.oauth.profile.twitter.TwitterConverters;

/**
 * Created by liutong on 2017/3/2.
 */
public class YcTwitterAttributesDefinition extends OAuthAttributesDefinition {
    /* 添加单点登录自定义属性 start*/
    ...
    public YcTwitterAttributesDefinition() {
        /* 添加单点登录自定义属性 start*/
        ...
        addAttribute(DOMAINNAME, Converters.stringConverter);
         /* 添加单点登录自定义属性 end*/
