 ...
 *
 */
public class BaiduOAuth20ServiceImpl extends ProxyOAuth20ServiceImpl {

    public BaiduOAuth20ServiceImpl(DefaultApi20 api, OAuthConfig config, int connectTimeout, int readTimeout, String proxyHost, int proxyPort) {
