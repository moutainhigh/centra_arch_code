...
public final class CustomClientAction extends AbstractAction {

    /**
     * The logger.
     */
    private final Logger logger = LoggerFactory.getLogger(CustomClientAction.class);
     ...
     */
    public CustomClientAction(final CentralAuthenticationService theCentralAuthenticationService,
    ...
    protected Event doExecute(final RequestContext context) throws Exception {
        ...
        if (StringUtils.isNotBlank(clientName)) {
            ...
            // get credentials
            // mod by gucl 2017-02-23 去掉final修饰符
            ...
            //==========start add by gucl 2017-02-23========
            catch(Exception e){
            	logger.error("获取credentials失败,重新跳转至单点登录页面 : {}", e);
            	credentials=null;
            }
            //==========start add by gucl 2017-02-23========
