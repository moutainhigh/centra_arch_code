...
public class APISearchSVImpl implements IAPISearchSV {
    ...
    @Override
    public List<APIOwnerType> getAPIOwnerTypes() throws BusinessException,SystemException {
    ...
    @Override
    public PageInfo<APISearchResult> searchAPIDocs(APISearchKey searchKey) throws BusinessException,SystemException {
        if (searchKey == null) {
        ...
        SearchResponse response = APISearchUtil.searchAPIsHighLight(searchKey,
                pageInfo.getStartRowIndex(), pageInfo.getEndRowIndex());
    ...
    @Override
    public String getAPIVersionHistory(String apiDetailIndexId) throws BusinessException,SystemException {
    ...
    @Override
    public String getAPIVersionNew(String apiDetailIndexId) throws BusinessException,SystemException {
        if (StringUtil.isBlank(apiDetailIndexId)) {
            throw new SystemException("获取API详细错误:缺少索引ID");
        }
    ...
    @Override
    public String getAPIClassDetail(String apiParamIndexId) throws BusinessException,SystemException {
    ...
    @Override
    public String getAPIStatistics() throws BusinessException,SystemException {
    ...
    @Override
    public void deleteAPINew(String indexId) throws BusinessException,SystemException {
    ...
    @Override
    public String downloadAPIs(String ownerType, String owner) throws BusinessException,SystemException {
    ...
    public String downloadAPI(String ownerType, String owner, String artifactId,
            String interfaceName, String method) throws BusinessException,SystemException {
        if (StringUtil.isBlank(ownerType)) {
            throw new SystemException("提供者类型不能为空");
        }
        if (StringUtil.isBlank(owner)) {
    ...
    @Override
    public void saveAPIEnvSettings(APIEnvSettings envSettings) throws BusinessException,SystemException {
        if (envSettings == null) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "API环境信息不能为空");
        }
        if (StringUtil.isBlank(envSettings.getOwnertype())) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "API提供者类型不能为空");
        }
        if (StringUtil.isBlank(envSettings.getOwner())) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "API提供者不能为空");
        }
        if (StringUtil.isBlank(envSettings.getEnv())) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "环境标识不能为空");
        }
        if (StringUtil.isBlank(envSettings.getZkcenter())) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "注册中心地址不能为空");
        }
    ...
    public List<APIEnvSettings> getAPIEnvSettings(String ownerType, String owner)
        ...
        if (StringUtil.isBlank(ownerType)) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "提供者类型不能为空");
        }
        if (StringUtil.isBlank(owner)) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "提供者不能为空");
        }
    ...
    @Override
    public List<APIEnvSettings> getAllAPIEnvSettings() throws BusinessException,SystemException {
        ApiEnvSettingsCriteria sql = new ApiEnvSettingsCriteria();
        List<ApiEnvSettings> list = iApiEnvSettingsAtomSV.selectByExample(sql);
        List<APIEnvSettings> l = new ArrayList<APIEnvSettings>();
        if (!CollectionUtil.isEmpty(list)) {
    ...
    @Override
    public APIEnvSettings getAPIEnvSetting(String settingId) throws BusinessException,SystemException {
        if (StringUtil.isBlank(settingId)) {
            throw new BusinessException(ExceptCodeConstants.Special.PARAM_IS_NULL, "设置ID不能为空");
        }
        ApiEnvSettingsCriteria sql = new ApiEnvSettingsCriteria();
