...
public class SandBoxSVImpl implements ISandBoxSV {
    ...
    @Override
    public APICallSetting getAPICallSettingFromES(String indexId) throws BusinessException,SystemException {
    ...
    @Override
    public void saveAPICallSetting(APICallSetting req) throws BusinessException,SystemException {
        if (req == null) {
    ...
    @Override
    public void saveAPICallCase(APICallCase callCase) throws BusinessException,SystemException {
        if (callCase == null) {
    ...
    @Override
    public String excuteTest(APICallCase callCase, String registryURL) throws BusinessException,SystemException {
        if (callCase == null) {
    ...
    @Override
    public void setAPISandboxSetting(APICallSetting req) throws BusinessException,SystemException {
        if (req == null) {
    ...
    @Override
    public PageInfo<APICallCase> queryAPICallCases(APICallCaseQuery query) throws BusinessException,SystemException {
        if (query == null) {
    ...
    @Override
    public boolean checkRegistryAvailable(String registryURL) throws BusinessException,SystemException {
        boolean check = DubboMockUtil.checkRegistryAvailable(registryURL);
        return check;
    }

    @Override
    public APIRest getAPIRest(String indexId) throws BusinessException,SystemException {
        if (StringUtil.isBlank(indexId)) {
    ...
    @Override
    public String testRest(APIRestTestReq restTestReq) throws BusinessException,SystemException {
        if (restTestReq == null) {
