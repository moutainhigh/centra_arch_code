define('app/jsp/order/orderProductDetail', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var OrderProductDetail = Widget.extend({
    	...
    	//重写父类
    	setup: function () {
    		OrderProductDetail.superclass.setup.call(this);
