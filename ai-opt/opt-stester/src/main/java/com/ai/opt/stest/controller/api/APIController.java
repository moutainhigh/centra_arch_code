package com.ai.opt.stest.controller.api;

import com.ai.opt.stest.api.apisearch.IAPISearchSV;
import com.ai.opt.stest.api.apisearch.param.APIOwnerType;
import com.ai.opt.stest.api.apisearch.param.APISearchKey;
import com.ai.opt.stest.api.apisearch.param.APISearchResult;
import com.ai.opt.stest.base.exception.SystemException;
import com.ai.opt.stest.base.model.ResponseData;
import com.ai.opt.stest.base.util.StringUtil;
import com.ai.opt.stest.constants.ElasticIndex;
import com.ai.opt.stest.constants.ElasticType;
import com.ai.opt.stest.util.ElasticSearchUtil;
