...
<div class="tab-content">
	...
	<div class="tab-pane fade in active" id="profile">
		...
		<div class="form-group" style="margin-top: 20px"
			...
			<div style="width: 100%; height: 400px;">
				...
				<div id="REQ_JSONEDITOR_1" class="JSONEDITOR" jsonValue='${ZFB.configInfo }' paramjson="{}"></div>
			</div>
		</div>
	...
	<div class="tab-pane fade" id="messages">
		...
		<div class="form-group" style="margin-top: 20px"
			...
			<div style="width: 100%; height: 400px;">
				<div id="REQ_JSONEDITOR_2" class="JSONEDITOR" jsonValue='${WEIXIN.configInfo }' paramjson="{}"></div>
			</div>
		</div>
	...
	<div class="tab-pane fade" id="settings">
		...
		<div class="form-group" style="margin-top: 20px"
			...
			<div style="width: 100%; height: 400px;">
				<div id="REQ_JSONEDITOR_3" class="JSONEDITOR" jsonValue='${YL.configInfo }' paramjson="{}"></div>
			</div>
		</div>
