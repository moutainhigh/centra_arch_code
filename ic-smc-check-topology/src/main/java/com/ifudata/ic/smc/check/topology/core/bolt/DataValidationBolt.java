...
import com.ifudata.ic.smc.check.topology.vo.StlElement;
...
//        }
    ...
    public void execute(Tuple input, BasicOutputCollector collector) {
        ...
        try {
            ...
            // 根据政策编码获取账单格式定义
            String policyStr = RedisUtil.hget(SmcCacheConstant.NameSpace.POLICY_CACHE, tenantId
                    + "." + policyCode);
            ...
            /* 获取此账单格式定义下的所有的详单项定义； */
            String billDetailStyleStr = RedisUtil.hget(
            ...
            try {
                for (int i = 0; i < stlBillDetailStyleItems.size(); i++) {
                    ...
                    String elementStr = RedisUtil.hget(
            ...
            Long countTmp = RedisUtil.incr(countKey);
