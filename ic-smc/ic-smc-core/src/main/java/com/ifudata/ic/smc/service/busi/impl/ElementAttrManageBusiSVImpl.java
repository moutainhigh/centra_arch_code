...
import com.ifudata.ic.smc.dao.mapper.bo.StlElementAttrCriteria;
...
public class ElementAttrManageBusiSVImpl implements IElementAttrManageBusiSV{
	...
	public StlElementAttr searchElementAttrByElementId(Long elementId) {
		...
		com.ifudata.ic.smc.dao.mapper.bo.StlElementAttrCriteria.Criteria	criteria=stlElementAttrCriteria.createCriteria();
