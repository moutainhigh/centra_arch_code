package com.ifudata.dvp.pay.web.test.simulator;
...
import com.ifudata.dvp.pay.web.system.util.HTTPUtil;
...
public class AlipayNotifySimulator {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AlipayNotifySimulator.class);
