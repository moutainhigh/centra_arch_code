...
import com.ifudata.dvp.pay.web.business.payment.model.BaseRes;
...
public class MySimpleMappingExceptionResolver extends
	...
	private static final Logger LOG = LoggerFactory.getLogger(MySimpleMappingExceptionResolver.class);
	/**
	 * 响应客户端结果 成功、失败、错误
	 */
