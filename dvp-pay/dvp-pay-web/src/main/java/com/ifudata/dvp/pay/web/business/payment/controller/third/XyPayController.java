...
import com.ifudata.dvp.pay.web.business.payment.util.third.cib.AppClientServiceHolder;
import com.ifudata.dvp.pay.web.system.configcenter.AbstractPayConfigManager;
import com.ifudata.dvp.pay.web.system.configcenter.XyPayConfigManager;
...
public class XyPayController extends TradeBaseController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(XyPayController.class);
