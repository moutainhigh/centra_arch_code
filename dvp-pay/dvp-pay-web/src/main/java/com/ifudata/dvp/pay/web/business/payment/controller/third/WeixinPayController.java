...
import com.ifudata.dvp.pay.web.business.payment.model.TradeQueryRes;
...
import com.ifudata.dvp.pay.web.business.payment.util.third.weixin.CommonUtil;
import com.ifudata.dvp.pay.web.business.payment.util.third.weixin.WeixinOauth2Token;
import com.ifudata.dvp.pay.web.constants.PayCenterConstants;
import com.ifudata.dvp.pay.web.system.configcenter.AbstractPayConfigManager;
import com.ifudata.dvp.pay.web.system.configcenter.WeixinConfigManager;
...
import com.ifudata.dvp.pay.web.system.util.HTTPSUtil;
...
//                String[] orderInfoArray = this.splitTradeOrderId(out_trade_no);
    ...
    public void payAuthorization(HttpServletRequest request, HttpServletResponse response,
        ...
        // backUri = "http://wxpay.minshengec.com/PAY/weixin/toPay";
