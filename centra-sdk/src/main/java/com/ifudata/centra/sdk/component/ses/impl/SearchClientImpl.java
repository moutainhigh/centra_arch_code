package com.ifudata.centra.sdk.component.ses.impl;
...
import com.ifudata.centra.sdk.constant.SdkConstant;
import com.ifudata.centra.sdk.component.ses.common.JsonBuilder;
import com.ifudata.centra.sdk.component.ses.exception.SearchRuntimeException;
import com.ifudata.centra.sdk.component.ses.interfaces.ISearchClient;
import com.ifudata.centra.sdk.component.ses.vo.*;
...
public class SearchClientImpl implements ISearchClient {
	...
	private <T> Result<T> search(QueryBuilder queryBuilder, int from, int offset, List<Sort> sorts, Class<T> clazz,
		...
		result.setResultCode(ExceptionCodeConstant.SYSTEM_ERROR);
		try {
			/* 查询搜索总数 */
			...
			result.setResultCode(SdkConstant.RPC_CALL_OK);
		} catch (Exception e) {
