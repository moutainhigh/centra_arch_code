define("arale-select/0.11.1/index-debug", ["arale-overlay/1.2.0/overlay-debug","jquery","position/1.1.0/index-debug","arale-iframe-shim/1.1.0/index-debug","arale-widget/1.2.0/widget-debug","arale-base/1.2.0/base-debug","arale-class/1.2.0/class-debug","arale-events/1.2.0/events-debug","arale-templatable/0.10.0/src/templatable-debug","handlebars/1.3.0/dist/cjs/handlebars-debug","handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){

module.exports = require("arale-select/0.11.1/src/select-debug");

});
define("arale-select/0.11.1/src/select-debug", ["arale-overlay/1.2.0/overlay-debug","jquery","position/1.1.0/index-debug","arale-iframe-shim/1.1.0/index-debug","arale-widget/1.2.0/widget-debug","arale-base/1.2.0/base-debug","arale-class/1.2.0/class-debug","arale-events/1.2.0/events-debug","arale-templatable/0.10.0/src/templatable-debug","handlebars/1.3.0/dist/cjs/handlebars-debug","handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
...
var template = require("arale-select/0.11.1/src/select-debug.handlebars");
...
define("arale-select/0.11.1/src/select-debug.handlebars", ["handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
...
function program1(depth0,data,depth1) {
  ...
  buffer += escapeExpression(stack1)
    ...
    + escapeExpression(helpers['toString'].call(depth0, (depth0 && depth0.defaultSelected), {hash:{},data:data}))
    + "\"\n          data-selected=\""
    + escapeExpression(helpers['toString'].call(depth0, (depth0 && depth0.selected), {hash:{},data:data}))
    + "\"\n          data-disabled=\""
    + escapeExpression(helpers['toString'].call(depth0, (depth0 && depth0.disabled), {hash:{},data:data}))
    + "\">";
