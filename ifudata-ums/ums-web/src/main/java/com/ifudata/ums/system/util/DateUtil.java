...
public class DateUtil {
     ...
     * @param format
     * @return
     * @author limy6 <2015-08-19 13:11>
     */
	public static Timestamp to_timestamp(String dateStr, String format) throws Exception, ParseException {
    ...
    public static Timestamp string3Datestamp(String timestamp) throws Exception{
        if(timestamp==null||timestamp.length()<10)
            return null;
        Timestamp ts = Timestamp.valueOf(timestamp.trim()+" 59:59:59");
        return ts;
    }
